...
public class Bounds implements Serializable {
	...
	public boolean intersectsLine(double x1, double y1, double x2, double y2) {
		...
		double dYIntersectionatx1 = dSlope * (_dX1 - x1) + y1;
		double dYIntersectionatx2 = dSlope * (_dX2 - x1) + y1;
		double dXIntersectionaty1 = (_dY1 - y1) / dSlope +  x1;
		double dXIntersectionaty2 = (_dY2 - y1) / dSlope +  x1;

		return (intersectsPoint(_dX1, dYIntersectionatx1)) ||
			(intersectsPoint(_dX2, dYIntersectionatx2)) ||
			(intersectsPoint(dXIntersectionaty1, _dY1)) ||
			(intersectsPoint(dXIntersectionaty2, _dY2));
	}
