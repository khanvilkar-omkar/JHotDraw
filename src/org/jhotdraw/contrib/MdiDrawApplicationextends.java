 ...
 */
public class MdiDrawApplicationextends extends DrawApplication {
	...
	public MdiDrawApplicationextends() {
		this("JHotDraw");
	 ...
	 */
	public MdiDrawApplicationextends(String title) {
		super(title);
	}
	...
	protected DrawApplication createApplication() {
		return new MdiDrawApplicationextends();
	}
